...
if DB_ENGINE == "sqlite" or os.getenv("USE_SQLITE", "false").lower() in ("true", "1", "yes"):
    DATABASES = {
        "default": {
...
# A dotted callable receiving (Path, DatabaseBackup), intentionally disabled by default.
BACKUP_UPLOAD_HOOK = os.getenv("BACKUP_UPLOAD_HOOK", "")
